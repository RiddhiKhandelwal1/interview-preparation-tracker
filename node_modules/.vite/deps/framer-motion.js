...
function startViewAnimation(builder) {
    ...
    targets.forEach((target, definition) => {
      ...
      if (definition === "root" || !resolveDefs.has(definition)) {
        ...
        if (phase === "old") {
          ...
          names = assignViewTransitionNames(definition, nameRegistry, assigned, void 0, className, classed);
  ...
  const cropRadii = /* @__PURE__ */ new Map();
  const recordRadii = (style2, name, phase) => {
    const corners = {};
    for (const corner of cornerProps)
      corners[corner] = style2[corner];
  ...
  return new Promise((resolve, reject) => {
    transition.ready.then(() => {
      ...
      cropRadii.forEach((radii, name) => {
        ...
        for (const corner of cornerProps) {
          const from = ((_a = radii.old) == null ? void 0 : _a[corner]) || ((_b = radii.new) == null ? void 0 : _b[corner]) || "0px";
          const to = ((_c = radii.new) == null ? void 0 : _c[corner]) || ((_d = radii.old) == null ? void 0 : _d[corner]) || "0px";
